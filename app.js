...
function checkk(){
   ...
   default:
        document.getElementById("aaa").innerHTML="The answer is wrong " +" "+"here are some of the ways to write it :"+"<br>"+q2[0]+"<br>"+q2[1]+"<br>"+q2[2]; //could been done with creating an li 
        break;
    } 
